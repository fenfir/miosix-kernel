...
{
    (void)spLimit;   //hardware stack-overflow detection is an MPU job; the
                     //HR_C7000 has no MPU, so it is not enforced here.
    ...
    frame[16]=(1u<<31)|(1u<<CK803S_PSR_EE_BIT)|(1u<<CK803S_PSR_IE_BIT); //0x80000140
